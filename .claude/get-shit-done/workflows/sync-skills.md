...
INSTALL_JS_GLOBAL="/Users/ludwigmatt/Projects/Merger Intelligence Agent/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/ludwigmatt/Projects/Merger Intelligence Agent/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
