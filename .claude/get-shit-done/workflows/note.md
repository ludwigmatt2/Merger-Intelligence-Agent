...
- **Global scope**: `/Users/ludwigmatt/Projects/Merger Intelligence Agent/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/ludwigmatt/Projects/Merger Intelligence Agent/.claude/notes/`)
...
2. Glob `/Users/ludwigmatt/Projects/Merger Intelligence Agent/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/ludwigmatt/Projects/Merger Intelligence Agent/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/ludwigmatt/Projects/Merger Intelligence Agent/.claude/notes/` — works in any directory
