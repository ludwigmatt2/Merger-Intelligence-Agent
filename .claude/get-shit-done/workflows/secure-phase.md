...
```
Task(
  prompt="Read /Users/ludwigmatt/Projects/Merger Intelligence Agent/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/ludwigmatt/Projects/Merger Intelligence Agent/.claude/get-shit-done/templates/SECURITY.md`
