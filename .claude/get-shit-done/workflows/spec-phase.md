...
```bash
INIT=$(node "/Users/ludwigmatt/Projects/Merger Intelligence Agent/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/ludwigmatt/Projects/Merger Intelligence Agent/.claude/get-shit-done/templates/spec.md.
