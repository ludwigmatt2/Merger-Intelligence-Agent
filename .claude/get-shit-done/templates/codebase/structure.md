...
- Usage: Reference from command with `@/Users/ludwigmatt/Projects/Merger Intelligence Agent/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/ludwigmatt/Projects/Merger Intelligence Agent/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/ludwigmatt/Projects/Merger Intelligence Agent/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
