...
<required_reading>
Read `/Users/ludwigmatt/Projects/Merger Intelligence Agent/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
